# NidaanAI - Multi-Disease Prediction System

NidaanAI is a comprehensive multi-disease prediction platform designed to predict heart disease, diabetes, breast cancer, and lung cancer. Built using the MERN stack and integrated with machine learning models, NidaanAI offers an intuitive interface for users to input data and receive accurate health predictions, enhancing the diagnostic experience.
...
The frontend design has been created using [Figma](https://www.figma.com/design/psQyNMetXUsjCcvmvvjqIg/NidaanAI---Final-Year-Project?node-id=0-1&t=KuA0zys1uwoHgMxW-1). It outlines the structure and user flow of the application, ensuring a seamless user experience.
...
### Homepage
![Homepage](https://raw.githubusercontent.com/hallowshaw/NidaanAI/main/Screenshots/SS1.png)

### Sign Up Page
![Sign Up](https://raw.githubusercontent.com/hallowshaw/NidaanAI/main/Screenshots/SS2.png)

### Predictors Page
![Predictors](https://raw.githubusercontent.com/hallowshaw/NidaanAI/main/Screenshots/SS3.png)

### About Page
![About](https://raw.githubusercontent.com/hallowshaw/NidaanAI/main/Screenshots/SS4.png)
...
- **Mobile Application:** Expand NidaanAI into a cross-platform mobile app using React Native.
